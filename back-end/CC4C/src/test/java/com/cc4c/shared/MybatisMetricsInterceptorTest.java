...
class MybatisMetricsInterceptorTest {
    ...
    void recordsFixedModuleCommandAndOutcomeWithoutStatementIdentifier() throws Throwable {
        ...
        MybatisMetricsInterceptor interceptor = new MybatisMetricsInterceptor(
                new Cc4cMetrics(registry, properties()));
        Invocation invocation = invocation(
                "com.cc4c.catalog.internal.CatalogMapper.findHome",
    ...
    void recordsErrorAndAlwaysRestoresNestedDepth() throws Throwable {
        ...
        Invocation failed = invocation(
                "com.cc4c.interaction.internal.InteractionMapper.updateFavorite",
        ...
        Invocation next = invocation(
                "com.cc4c.identity.internal.IdentityMapper.findUser",
                SqlCommandType.SELECT,
                "ok");
