...
public class MessagingAdminController {
    ...
    public ApiResponse<Boolean> ignore(
        ...
        String actorId = principalName.startsWith("ADMIN:")
                ? principalName.substring("ADMIN:".length())
                : principalName;
