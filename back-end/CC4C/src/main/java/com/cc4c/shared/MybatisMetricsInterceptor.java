...
final class MybatisMetricsInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        try {
            ...
            metrics.record("cc4c.mybatis.operations", startedNanos,
                    "module", module, "command", command, "outcome", "success");
            return result;
        } catch (Throwable throwable) {
            metrics.record("cc4c.mybatis.operations", startedNanos,
                    "module", module, "command", command, "outcome", "error");
            throw throwable;
        } finally {
            restoreDepth(currentDepth);
        }
    ...
    private String moduleFor(String statementId) {
        for (String module : new String[]{
                "identity", "catalog", "community", "interaction", "moderation", "shared"}) {
