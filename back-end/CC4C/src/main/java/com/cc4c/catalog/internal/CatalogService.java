...
public class CatalogService implements CatalogLookup {
    ...
    public PageResult<CourseResponse> home(PageQuery query) {
        return cachedPage(HOME_REGION, pageKey(query), HOME_TTL,
    ...
    public CourseResponse byName(String courseName) {
        return cache.getOrLoad(
                ...
                .orElseThrow(() -> new BusinessException(
                        ...
                        BusinessCode.COURSE_GET_ONE_FAILED,
    ...
    public CourseResponse createCourse(CourseCreateRequest request) {
        ...
        cache.invalidateAfterCommit(
                HOME_REGION, LANGUAGE_REGION, DETAIL_REGION, MODULES_REGION, RECOMMEND_REGION);
    ...
    private List<CourseModuleResponse> loadModules(int languageId) {
        Map<Integer, List<String>> courseNames = groupCourseNames(
                mapper.selectCourseNamesByLanguage(languageId));
    ...
    private List<CourseModuleResponse> loadRecommendation(
            ...
            int courseMaximum) {
        Map<Integer, List<String>> courseNames = groupCourseNames(
                mapper.selectRecommendedCourseNamesByLanguage(
                        languageId, courseMinimum, courseMaximum));
    ...
    private CourseModuleResponse moduleResponse(
            CourseModuleRow module, Map<Integer, List<String>> courseNames) {
        return new CourseModuleResponse(
