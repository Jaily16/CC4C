...
$performanceFile = Join-Path $PSScriptRoot '.env.performance.local'
$runtimeFile = Join-Path $PSScriptRoot '.env.runtime.local'
$observabilityFile = Join-Path $workspaceRoot 'observability\.env.observability.local'
