          ...
          >
            ...
            <div class="blog-card__body">
              ...
              <div class="blog-card__footer">
                <span v-if="blog.click !== undefined" class="blog-card__views"
...
async function openBlog(blogId) {
  try {
    ...
    reportClientError(error, 'frontend/src/views/blog/AllBlogsView.vue');
  }
...
async function loadBlogs() {
  ...
  errorMessage.value = '';
  try {
    const resp = await listAllBlogs({ page: currentPage.value, size: pageSize });
...
.blog-card:focus-visible .blog-card__action {
