...
import ContentActionBar from '@/components/ContentActionBar.vue';
...
/** 清空旧详情和评论后按路由课程名读取正文，加载评论，USER 另查询收藏状态。 */
...
/** 为当前 USER 增加或取消课程收藏，只有后端明确成功才切换状态。 */
