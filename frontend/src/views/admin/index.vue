...
import { logoutAdmin, updateAdminPassword } from '@/api/auth';
...
async function logout() {
  try {
    ...
    reportClientError(error, 'frontend/src/views/admin/index.vue');
  } finally {
    resetCsrfToken();
...
@media (max-width: 1024px) {
  ...
  .admin-mobile-nav__active {
    color: var(--cc4c-primary) !important;
    background: #eef4ff;
    box-shadow: inset 0 -3px var(--cc4c-primary);
  }
  .admin-main {
    padding: 142px 22px 28px;
  }
}
