...
<script setup>
/** 管理员异步消息页面，按状态与事件类型查询摘要，经确认后请求重试或忽略指定事件。 */
import { ref } from 'vue';
...
/** 按事件类型、状态和页码读取消息摘要；空的非首页逐页回退后再读。 */
