...
class ReliableMessageProcessorTest {
    ...
    void duplicateDoneMessageIsAckedWithoutRunningHandlerAgain() throws Exception {
        ...
        when(fixture.inbox.claim(any(), any(), eq(0), any(), any())).thenReturn(InboxClaim.ALREADY_DONE);

        fixture.processor.process(
                "consumer", AsyncEventTypes.BLOG_SUBMITTED, fixture.message, fixture.channel, 7L, fixture.handler);
    ...
    void successfulHandlingCommitsInboxAndOutboxBeforeAck() throws Exception {
        Fixture fixture = fixture();
        when(fixture.inbox.claim(any(), any(), eq(0), any(), any())).thenReturn(InboxClaim.ACQUIRED);

        fixture.processor.process(
                "consumer", AsyncEventTypes.BLOG_SUBMITTED, fixture.message, fixture.channel, 8L, fixture.handler);
    ...
    void legacyMessageWithoutCorrelationHeaderUsesEventIdAndClearsMdc() throws Exception {
        ...
        fixture.processor.process(
                "consumer", AsyncEventTypes.BLOG_SUBMITTED, fixture.message, fixture.channel, 16L, fixture.handler);
    ...
    void transientFailureAcksOnlyAfterConfirmedRetryPublish() throws Exception {
        ...
        org.mockito.Mockito.doThrow(new MailDeliveryException("MAIL_TRANSIENT", false, null))
                .when(fixture.handler)
                .handle(any(), any());
        when(fixture.topology.retryDelays())
                .thenReturn(List.of(Duration.ofSeconds(30), Duration.ofMinutes(5), Duration.ofMinutes(30)));
        when(fixture.topology.retryQueue(AsyncEventTypes.BLOG_SUBMITTED, 0)).thenReturn("retry.30s");
        when(fixture.publisher.publish(eq(""), eq("retry.30s"), any(), any())).thenReturn(PublishOutcome.confirmed());

        fixture.processor.process(
                "consumer", AsyncEventTypes.BLOG_SUBMITTED, fixture.message, fixture.channel, 9L, fixture.handler);

        verify(fixture.inbox).markRetryWaiting("consumer", "event-1", 0, "MAIL_TRANSIENT");
    ...
    void unconfirmedRetryPublishRequeuesOriginalMessage() throws Exception {
        ...
        fixture.processor.process(
                "consumer", AsyncEventTypes.BLOG_SUBMITTED, fixture.message, fixture.channel, 10L, fixture.handler);
    ...
    void unsupportedVersionIsPersistedAsDeadAndAckedOnlyAfterConfirmedDlqPublish() throws Exception {
        ...
        when(fixture.publisher.publish(eq("dead.events"), any(), any(), any())).thenReturn(PublishOutcome.confirmed());

        fixture.processor.process(
                "consumer", AsyncEventTypes.BLOG_SUBMITTED, fixture.message, fixture.channel, 11L, fixture.handler);
    ...
    void unconfirmedDlqPublishRequeuesOriginalWithoutAcknowledgingIt() throws Exception {
        ...
        fixture.processor.process(
                "consumer", AsyncEventTypes.BLOG_SUBMITTED, fixture.message, fixture.channel, 12L, fixture.handler);
    ...
    void malformedEnvelopeUsesMessageReferenceToPersistDeadBeforeBrokerDlxReject() throws Exception {
        ...
        when(fixture.inbox.claim(any(), eq(eventId), eq(2), any(), any())).thenReturn(InboxClaim.ACQUIRED);

        fixture.processor.process(
                "consumer", AsyncEventTypes.BLOG_SUBMITTED, malformed, fixture.channel, 13L, fixture.handler);
    ...
    void expiredMessageIsClaimedAndCompletedWithoutCallingBusinessHandler() throws Exception {
        ...
        fixture.processor.process(
                "consumer", AsyncEventTypes.BLOG_SUBMITTED, fixture.message, fixture.channel, 14L, fixture.handler);
    ...
    void alreadyCompletedExpiredDuplicateDoesNotOverwriteDeliveredState() throws Exception {
        ...
        fixture.processor.process(
                "consumer", AsyncEventTypes.BLOG_SUBMITTED, fixture.message, fixture.channel, 15L, fixture.handler);
    ...
    private Fixture fixture(Message message) {
        ...
        ReliableMessageProcessor processor =
                new ReliableMessageProcessor(inbox, outbox, cipher, objectMapper, publisher, topology);
