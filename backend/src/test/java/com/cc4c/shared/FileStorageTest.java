...
class FileStorageTest {
    ...
    void uploadedFileNamesCannotEscapeTheConfiguredStorageRoot() {
        MockMultipartFile file = new MockMultipartFile("file", "../../outside.png", "image/png", new byte[] {1, 2, 3});

        FileStorage.StoredFile stored =
                FileStorage.storeImage(file, storageRoot.toString(), "http://localhost:5173/test");
