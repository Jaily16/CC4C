...
class MessagingPropertiesTest {
    ...
    void moderationRecipientsAreValidatedNormalizedAndDeduplicatedAtConstruction() {
        MessagingProperties properties = properties(" Reviewer@Example.com,reviewer@example.com, second@example.com ");

        assertEquals(List.of("reviewer@example.com", "second@example.com"), properties.moderationRecipientList());
