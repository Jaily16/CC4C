...
class RedisReadinessVerifierTest {
    ...
    void acceptsPongAndRejectsUnexpectedResponses() {
        ...
        assertThrows(IllegalStateException.class, () -> verifier.run(new DefaultApplicationArguments()));
    }
    ...
    void propagatesConnectionFailureInsteadOfFallingBack() {
        ...
        assertThrows(RedisConnectionFailureException.class, () -> new RedisReadinessVerifier(factory)
