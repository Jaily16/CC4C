...
class IdentityMessageConsumerTest {
    ...
    void expiredAndDeadEventsDiscardOnlyTheirMatchingVerificationRecord() throws Exception {
        ...
        verify(fixture.codes, org.mockito.Mockito.times(2))
                .discardIfCurrent("recipient@example.com", VerificationPurpose.REGISTER, "event-1");
        verify(fixture.mail, never()).sendText(any(), any(), any(), any());
    }
    ...
    private Fixture fixture() throws Exception {
        ...
        IdentityMessageConsumer consumer = new IdentityMessageConsumer(processor, objectMapper, codes, mail);
        ...
        MessageEnvelope envelope = new MessageEnvelope(
                ...
                new byte[12],
                new byte[] {1});
        byte[] plaintext = objectMapper.writeValueAsBytes(
                new VerificationEmailRequestedV1("recipient@example.com", VerificationPurpose.REGISTER, "246810"));
